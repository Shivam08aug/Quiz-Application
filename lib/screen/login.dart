// ignore_for_file: prefer_const_constructors, duplicate_import, unused_import, library_private_types_in_public_api, use_build_context_synchronously
import 'package:flutter/material.dart';
import 'package:flutter_signin_button/flutter_signin_button.dart';
import 'package:internet_connection_checker/internet_connection_checker.dart';
import 'package:flutter_application/screen/home.dart';
import 'package:flutter_application/services/InternetCon.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Column(
        ...
        children: [
        Image.asset("assets/quiz image.jpg"),
        SizedBox(height: 35,),
